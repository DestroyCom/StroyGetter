...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/how-to-use-library-ready" },
  openGraph: {
    title:
    ...
    url: `${siteConfig.url}/how-to-use-library-ready`,
  },
};
...
export default function HowToUseLibraryReadyPage() {
  return (
    <>
      <JsonLd
        data={{
      ...
      <article className="bg-stroy-500 px-4 py-16 md:px-14">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="mb-6 text-balance text-4xl font-bold leading-[1.05] tracking-tight md:text-[52px]">
            How to download YouTube music with cover art, ID3 tags and synced
            lyrics
          </h1>

          <p className="mb-10 text-lg leading-relaxed text-white/82">
            A complete walkthrough of StroyGetter's Library Ready mode — the
            only free online tool that embeds cover art, metadata and scrolling
            lyrics in a single click.
          </p>
          ...
          <div className="space-y-6 text-base leading-[1.75] text-white/88">
            ...
            <p>
              Library Ready is StroyGetter's premium download mode. Instead of
              giving you a bare MP3 with no context, it fetches the track's full
              metadata from YouTube Music and embeds everything directly into
              the file before it reaches your device:
            </p>
            ...
            <p>
              The result is a file that drops cleanly into Apple Music, Plex,
              Plexamp, Rekordbox, foobar2000 or whichever music player you love,
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={item} className="flex gap-3">
                  <span className="mt-1 shrink-0 font-bold text-stroy-300">
                    →
                  </span>
                  {item}
                </li>
            ...
            <p>
              On desktop, click your browser's address bar while the video is
              open and press <strong>Cmd+C</strong> (Mac) or{" "}
              <strong>Ctrl+C</strong> (Windows). On the YouTube mobile app, tap{" "}
              <strong>Share → Copy link</strong>. YouTube Music links (
            ...
            <p>
              ...
              , paste the link in the search field, and click{" "}
              <strong>Search video</strong>. You'll see the video title, channel
              and duration so you can confirm it's the right track before going
              any further.
            </p>
            ...
            <p>
              On the result page you'll see three format tabs:{" "}
              <strong>MP4</strong>, <strong>MP3</strong> and{" "}
              <strong>Library Ready</strong>. Click Library Ready. That's all —
              the metadata and lyrics are fetched automatically.
            </p>
            ...
            <div className="my-8 grid grid-cols-[32px_1fr] gap-4 rounded-2xl border border-amber-500/30 bg-amber-500/8 p-6">
              ...
              <div className="text-sm leading-relaxed">
                <strong className="mb-1 block text-white">
                  Expect 20–35 seconds
                </strong>
                <span className="text-white/85">
                  Library Ready makes extra calls to fetch and embed the
                  metadata. The progress bar will move — don't close the tab. A
                  plain MP3 is faster if you're in a hurry and don't need the
                  tags.
                </span>
              </div>
            </div>
            ...
            <p>
              Click <strong>Download</strong>. The tagged MP3 streams directly
              from our converter to your browser. Once saved, drag it into your
              music player's library or use{" "}
              <strong>File → Add to Library</strong> in Apple Music. The cover
              art, tags and lyrics will appear immediately, no additional steps
              required.
            </p>
            ...
            <p>
              Synced lyrics are stored as SYLT tags inside the ID3 container.
              Every major audiophile-grade player reads them:
            </p>
            <ul className="space-y-2">
              {[
          ...
          <div className="mt-16 rounded-2xl border border-white/10 bg-stroy-800 p-10 text-center">
            ...
            <p className="mb-6 text-white/75">
              Paste a YouTube music link and pick Library Ready — your track
              will be perfectly tagged in under a minute.
            </p>
            <Link
              href="/"
